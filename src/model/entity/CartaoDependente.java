...
public class CartaoDependente implements Cartao {
	...
	public CartaoDependente(int idconta, boolean principal, boolean dependente) {
	...
	public double defineLimite(double limite) {
		BigDecimal bd = new BigDecimal(limite).setScale(2, RoundingMode.HALF_EVEN);
		return bd.doubleValue();
	}
